...
export const ASSEMBLIES: Record<string, Assembly> = {
  ...
  "guest-house": {
    ...
    lines: [
      ...
      { desc: "Interior Doors", qty: (i) => r0(2 + i.baths) },
      { desc: "Door Hardware", qty: (i) => r0(2 + i.baths) },
      { desc: "LVT Flooring - Materials", qty: (i) => r0(i.sqft - i.baths * 50) },
      { desc: "LVT Flooring - Labor", qty: (i) => r0(i.sqft - i.baths * 50) },
      { desc: "Floor Tile", qty: (i) => r0(i.baths * 50) },
      { desc: "Floor Tile Labor", qty: (i) => r0(i.baths * 50) },
      { desc: "Shower Tile", qty: (i) => r0(i.baths * 60) },
      { desc: "Shower Door (Included Material & Labor)", qty: (i) => r0(i.baths) },
  ...
  "master-suite": {
    ...
    lines: [
      ...
      { desc: "LVT Flooring - Materials", qty: (i) => r0(i.sqft - 90) },
      { desc: "LVT Flooring - Labor", qty: (i) => r0(i.sqft - 90) },
  ...
  "whole-home-renovation": {
    ...
    lines: [
      ...
      { desc: "LVT Flooring - Materials", qty: (i) => r0(i.sqft - i.baths * 90) },
      { desc: "LVT Flooring - Labor", qty: (i) => r0(i.sqft - i.baths * 90) },
