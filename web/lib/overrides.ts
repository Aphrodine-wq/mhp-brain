...
export type EntityType = "project" | "sub" | "crew" | "estimate" | "live_flag";
...
const ALLOWED: Record<EntityType, Record<string, Set<string> | null>> = {
  project: { status: new Set(["Active", "Aging", "Bid", "Paused", "Complete", "Likely Done", "Dead", "Unknown"]), market: null, type: null },
